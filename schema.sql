...
-- Demo monitor account: manager@school.nz / password67
-- (the hash below is a real bcrypt hash of "password67")
INSERT INTO manager (coach_name, coach_email, coach_height_cm, phone_number, password) VALUES
    ('Alex', 'manager@school.nz', '187', '023554978', '$2a$12$c3VcRsy/1Vurck0L7ly.yuXizwBukK3CMrx6KFBqnY1Z8oLcMlvjK');
